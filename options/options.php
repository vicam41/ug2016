...
class NHP_Options{
	...
	*/
	function __construct($sections = array(), $args = array(), $extra_tabs = array()){
		...
		$defaults['footer_credit'] = __('', 'schema' );
		
		$defaults['help_tabs'] = array();
		$defaults['help_sidebar'] = __('', 'schema' );
		...
		// Demo Import
		add_action('wp_ajax_mts_install_demo', array(&$this,'mts_install_demo'));
									...
									echo '<div class="preset" data-nonce="'.$nonce.'" data-demo-id="'.esc_attr($key).'">';
										...
										echo '<div class="preset-actions-wrap">';
											...
											if ( !empty( $all_imported ) ) {
												...
												echo '<button class="button button-secondary import-demo-button"'.$disabled_button.'>'.__('Import Theme Options & Demo Content', 'schema' ).'</button>';
											}
										echo '</div>';
