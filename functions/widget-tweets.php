...
class mts_widget_recent_tweets extends WP_Widget {
	...
	public function widget($args, $instance) {
		...
		$tweets = $connection->get("https://api.twitter.com/1.1/statuses/user_timeline.json?screen_name=".$instance['username']."&count=10") or die(__( 'Couldn\'t retrieve tweets! Wrong username?', 'schema' ));
